export function UsedSpaceWidget(){
    return (
        <div className="flex flex-col gap-4 rounded-lg bg-violet-50 text-violet-500 px-4 py-5 ">
        <div className="flex flex-col space-y-1">
            <span className="text-sm leading-5 font-medium text-violet-700">Used Space</span>
        <p className="text-sm leading-5 text-violet-500">Your team has used 80% of your available space. Need more?</p>
        </div>
